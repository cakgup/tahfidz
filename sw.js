const CACHE_NAME = 'hifz-companion-v30-delete-click';
const CORE_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=20260616-delete-click',
  './js/config.js?v=20260616-delete-click',
  './js/app.js?v=20260616-delete-click',
